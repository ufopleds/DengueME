...
static const char qt_meta_stringdata_FilenamePage[] = {
    "FilenamePage\0\0name\0validateProject(QString)\0"
};
...
const QMetaObjectExtraData FilenamePage::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject FilenamePage::staticMetaObject = {
    { &QWizardPage::staticMetaObject, qt_meta_stringdata_FilenamePage,
      qt_meta_data_FilenamePage, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &FilenamePage::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_FilenamePage))
