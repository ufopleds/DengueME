...
static const char qt_meta_stringdata_WorkspaceView[] = {
    "WorkspaceView\0\0workspaceReloaded()\0"
...
const QMetaObjectExtraData WorkspaceView::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject WorkspaceView::staticMetaObject = {
    { &QTreeView::staticMetaObject, qt_meta_stringdata_WorkspaceView,
      qt_meta_data_WorkspaceView, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &WorkspaceView::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_WorkspaceView))
