...
#include "../../src/editor/components/constraints/doublespinboxrules.h"
...
static const char qt_meta_stringdata_DoubleSpinBoxRules[] = {
    "DoubleSpinBoxRules\0\0p\0precisionChanged(int)\0"
    "n\0minimumChanged(double)\0"
    "maximumChanged(double)\0stepChanged(double)\0"
};
...
const QMetaObjectExtraData DoubleSpinBoxRules::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject DoubleSpinBoxRules::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_DoubleSpinBoxRules,
      qt_meta_data_DoubleSpinBoxRules, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &DoubleSpinBoxRules::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_DoubleSpinBoxRules))
