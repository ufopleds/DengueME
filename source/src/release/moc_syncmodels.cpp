...
QT_MOC_LITERAL(7, 57, 12), // "updateAction"
QT_MOC_LITERAL(8, 70, 13), // "checkNewModel"
QT_MOC_LITERAL(9, 84, 12), // "finishedHead"
QT_MOC_LITERAL(10, 97, 7), // "timeout"
QT_MOC_LITERAL(11, 105, 14), // "downloadAction"
QT_MOC_LITERAL(12, 120, 5), // "error"
QT_MOC_LITERAL(13, 126, 27), // "QNetworkReply::NetworkError"
QT_MOC_LITERAL(14, 154, 4) // "code"

    },
    "SyncModels\0addLine\0\0qsLine\0progress\0"
    "nPercentage\0finished\0updateAction\0"
    "checkNewModel\0finishedHead\0timeout\0"
    "downloadAction\0error\0QNetworkReply::NetworkError\0"
    "code"
};
...
void SyncModels::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 4: _t->checkNewModel(); break;
        case 5: _t->finishedHead(); break;
        case 6: _t->timeout(); break;
        case 7: _t->downloadAction(); break;
...
const QMetaObject SyncModels::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_SyncModels.data,
      qt_meta_data_SyncModels,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *SyncModels::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_SyncModels.stringdata0))
        return static_cast<void*>(const_cast< SyncModels*>(this));
