...
QT_MOC_LITERAL(3, 21, 6) // "accept"
    ...
    "NewProject\0accepted\0\0accept"
};
...
void NewProject::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (NewProject::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&NewProject::accepted)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject NewProject::staticMetaObject = {
    { &QWizard::staticMetaObject, qt_meta_stringdata_NewProject.data,
...
// SIGNAL 0
void NewProject::accepted(QString _t1)
{
