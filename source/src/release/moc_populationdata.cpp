...
#include "../editor/components/populationdata.h"
...
struct qt_meta_stringdata_PopulationData_t {
    QByteArrayData data[1];
    char stringdata0[15];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_PopulationData_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_PopulationData_t qt_meta_stringdata_PopulationData = {
    {
QT_MOC_LITERAL(0, 0, 14) // "PopulationData"
...
const QMetaObject PopulationData::staticMetaObject = {
    { &Group::staticMetaObject, qt_meta_stringdata_PopulationData.data,
      qt_meta_data_PopulationData,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *PopulationData::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_PopulationData.stringdata0))
