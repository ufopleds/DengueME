...
QT_MOC_LITERAL(3, 23, 11), // "selectColor"
QT_MOC_LITERAL(4, 35, 6), // "insert"
QT_MOC_LITERAL(5, 42, 11), // "closeDialog"
QT_MOC_LITERAL(6, 54, 24), // "on_pushButton_OK_clicked"
QT_MOC_LITERAL(7, 79, 7), // "delItem"
QT_MOC_LITERAL(8, 87, 15) // "enableDelButton"

    },
    "ColorBar\0valueChanged\0\0selectColor\0"
    "insert\0closeDialog\0on_pushButton_OK_clicked\0"
    "delItem\0enableDelButton"
};
...
void ColorBar::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (ColorBar::*_t)(const QString & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ColorBar::valueChanged)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject ColorBar::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_ColorBar.data,
