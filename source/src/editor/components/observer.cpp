...
void Observer::setColorBar() {
    QFileDialog::Options options;
    QString selectedFilter;
    QString fileName = QFileDialog::getOpenFileName(this,
                                                    tr("Opening ColorBar CSV file"),
                                                    "",
                                                    tr("CSV Files (*.csv)"),
                                                    &selectedFilter,
                                                    options);
    if (!fileName.isEmpty()) {
        ...
        if (file.open(QFile::ReadOnly | QFile::Truncate)) {
            ...
            ui->colorBar_textEdit->setText(str);
...
void Observer::showColorDialog()
{
    this->c = new ColorBar();

    connect(this->c, SIGNAL(valueChanged(QString)), this, SLOT(ChangeValue(QString)));
