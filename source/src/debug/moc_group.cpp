...
static const char qt_meta_stringdata_Group[] = {
    ...
    "removeField()\0Field*\0addText()\0"
    "addInteger()\0addFloating()\0addCheckbox()\0"
...
void Group::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: { Field* _r = _t->addText();
            if (_a[0]) *reinterpret_cast< Field**>(_a[0]) = _r; }  break;
        case 4: { Field* _r = _t->addInteger();
            if (_a[0]) *reinterpret_cast< Field**>(_a[0]) = _r; }  break;
        case 5: { Field* _r = _t->addFloating();
            if (_a[0]) *reinterpret_cast< Field**>(_a[0]) = _r; }  break;
        case 6: { Field* _r = _t->addCheckbox();
            if (_a[0]) *reinterpret_cast< Field**>(_a[0]) = _r; }  break;
        case 7: { Field* _r = _t->addCombobox();
            if (_a[0]) *reinterpret_cast< Field**>(_a[0]) = _r; }  break;
        case 8: { ImportCsv* _r = _t->addCsv();
            if (_a[0]) *reinterpret_cast< ImportCsv**>(_a[0]) = _r; }  break;
        case 9: { Component* _r = _t->addComponent((*reinterpret_cast< Component*(*)>(_a[1])));
